            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('editCategory', [$category->id]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('name_dk') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name_dk" type="text" class="form-control" name="name_dk" value="{{ $category->name_dk }}" required>
                            ...
                            <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="icon" type="file" name="icon" value="{{ old('icon') }}">

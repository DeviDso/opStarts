            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Edit service - {{ $service->name . '/' . $service->name_dk }}
                    </div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('editService', [$service->id]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('name_dk') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name_dk" type="text" class="form-control" name="name_dk" value="{{ $service->name_dk }}" required>

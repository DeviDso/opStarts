<div id="general_info" class="tabcontent">
    ...
    <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="phone_number" type="text" class="form-control" name="phone_number" value="{{ $page->phone_number }}">
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="email" type="email" class="form-control" name="email" value="{{ $page->email }}">
            @if ($errors->has('email'))
                <span class="help-block">
    ...
    <div id="disabled_location">
        <input name="street_number" class="field" id="street_number" value="{{ $page->street_number }}">
